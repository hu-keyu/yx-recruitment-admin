...
public interface GradeExportLogDao {
   ...
   /**
	 ...
	 */	
     public List<GradeExportLog> selectOnePageByMap(Page page,Map<String,Object> map);
    /**
	 * 分页查询 包含对象条件
	 * @param page 分页对象
	 * @param gradeExportLog 查询对象
	 * @return List<GradeExportLog>
	 */	
     public List<GradeExportLog> selectOnePageByGradeExportLog(Page page,GradeExportLog gradeExportLog);
   ...
   /**
	 ...
	 */	
     ...
     /**
 	 * 分页查询 包含条件(查询教育局端错误文件)
 	 * @param page 分页对象
 	 * @param map  查询条件  
 	 * @return  List<GradeExportLog>
 	 */	
      public List<GradeExportLog> selectScorePageByMap(Page page,Map<String,Object> map);
   ...
   /**
	 ...
	 */	
      ...
      * @return
      */
     public String maxOrderNumberEducation(GradeExportLog gradeExportLog );
	 ...
	 */	
      ...
      * @return
      */
     public String maxOrderNumber(GradeExportLog gradeExportLog );
}
