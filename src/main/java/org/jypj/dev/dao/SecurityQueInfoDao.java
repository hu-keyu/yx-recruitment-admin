...
public interface SecurityQueInfoDao {
   ...
   /**
	 ...
	 */	
     public List<SecurityQueInfo> selectOnePageByMap(Page page,Map<String,Object> map);
    /**
	 * 分页查询 包含对象条件
	 * @param page 分页对象
	 * @param securityQueInfo 查询对象
	 * @return List<SecurityQueInfo>
	 */	
     public List<SecurityQueInfo> selectOnePageBySecurityQueInfo(Page page,SecurityQueInfo securityQueInfo);
   ...
   /**
	 ...
	 */	
      ...
      * @param list
      */
     public void updateMultiSecret(@Param(value="list") List<SecurityQueInfo> list);
}
