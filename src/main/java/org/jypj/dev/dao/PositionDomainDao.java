...
public interface PositionDomainDao {
   ...
   /**
	 ...
	 */	
     public List<PositionDomain> selectOnePageByMap(Page page,Map<String,Object> map);
    /**
	 * 分页查询 包含对象条件
	 * @param page 分页对象
	 * @param positionDomain 查询对象
	 * @return List<PositionDomain>
	 */	
     public List<PositionDomain> selectOnePageByPositionDomain(Page page,PositionDomain positionDomain);
