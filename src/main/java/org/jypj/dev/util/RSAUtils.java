...
public class RSAUtils {
     ...
     * @throws Exception 
     */
    public static String decryptStringByJs(String data, RSAPrivateKey privateKey) throws Exception {
        String text = decryptByPrivateKey(data,privateKey);
        if(text == null) {
            return null;
        }
