 ...
 * @author
 */
public class ScoreGradeTrial implements java.io.Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ScoreGradeTrial other = (ScoreGradeTrial) obj;
		if (id == null) {
			if (other.id != null)
				return false;
	...
	public ScoreGradeTrial(String grade, String projectId, String name, String ticketnum, String postName,
			String modifyuser) {
		super();
		this.grade = grade;
		this.projectId = projectId;
