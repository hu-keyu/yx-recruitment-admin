 ...
 * @author
 */
public class ScoreGradeStudy implements java.io.Serializable{

	private static final long serialVersionUID = 1L;
	
    private String id; //主键ID
    private String studentId; //学生ID
    private String grade; //考察成绩，备用字段
    private String result; //考察结果（1通过 2不通过）
	...
	public ScoreGradeStudy() {
		super();
	}

	public ScoreGradeStudy(String result, String projectId, String name, String ticketnum, String postName,
			String modifyuser) {
		super();
		this.result = result;
		this.projectId = projectId;
